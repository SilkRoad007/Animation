...
function handleIntroductionAnimations() {
  ...
  window.addEventListener('scroll', handleFormAnimations);
      ...
      // Fonction qui gère les animations de la section "Partenaires"
      function handlePartnerAnimations() {
        var partnerSection = document.querySelector('.partenaires');
        
        var p = partnerSection.querySelector('p');
        var div = partnerSection.querySelector('div');
        
        if (isElementVisible(partnerSection)) {
          p.classList.add('animate__animated', 'animate__shakeX');
          div.classList.add('animate__animated', 'animate__backInUp');
        } else {
          p.classList.remove('animate__animated', 'animate__shakeX');
      ...
      // Ajoute les événements "load" et "scroll" à la fonction handleIntroductionAnimations
      window.addEventListener('load', handlePartnerAnimations);
      window.addEventListener('scroll', handlePartnerAnimations); 